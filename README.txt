...
use login
CREATE TABLE login_cadastro (id int PRIMARY KEY AUTO_INCREMENT, nome varchar(50), email varchar(50), senha varchar(50))

Prontinho, agr é rodar nossa aplicação abrindo pelo arquivo index.html da pasta view.
