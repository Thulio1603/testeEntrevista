<?php
class Access {
    //CLASSE DESTINADA A CONEXУO E ALTERAЧеES NO BANCO DE DADOS
        ...
        try {
            ...
            if ($stmt->execute()) {
                if ($stmt->rowCount() > 0) {
                   ...
                   throw new PDOException("Erro: Nуo foi possэvel executar a declaraчуo sql");
            }
    ...
    public function pesquisa($nome, $email){
        try{
            ...
            if ($stmt->execute()) {
                ...
                echo "Erro: Nуo foi possэvel recuperar os dados do banco de dados";
            }
        } catch (PDOException $erro) {
            echo "Erro: ".$erro->getMessage();
        }
